...
There are a few ways to view your webpage.
...
We can also use an extension in VS CODE like Live Server. Once installed you should see the a `Go Live` button on the blue bar at the bottom of your VS CODE which will launch your webpage in your browser. 

When you change your html file, you will need to save it, then refresh your browser to see the changes.  
You can also use your dev tools to inspect your html elements.  To open your dev tools either right click on the browser and select `inspect` or you can use a mac keyboard shortcut `CMD + OPT + J`. 
